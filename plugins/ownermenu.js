...
`.trim()
    ...
    conn.sendFile(m.chat, Johannes, 'pp.jpg', str.trim(), { key: { remoteJid: '0@s.whatsapp.net' }, message: { imageMessage: { caption: '*By : Ditzzy*', jpegThumbnail: await (await fetch(pp)).buffer() }}})
  }
}
